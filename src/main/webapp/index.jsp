...
<%@page import="com.cart.snapcart.entities.Product"%>
<%@page import="com.cart.snapcart.dao.ProductDao"%>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="card product-card h-100">
                                ...
                                <div class="container text-center">
                                    <img class="card-img-top m-2" src="img/products/<%= p.getpPhoto()%>" 
                                         style="max-height: 200px; max-width: 100%; width: auto;" alt="Card image cap">
                                </div>
